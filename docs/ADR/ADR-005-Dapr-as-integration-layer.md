...
## Decision:
The current implementation primarily uses Dapr Pub/Sub for asynchronous communication between services. The architecture is designed to support additional Dapr building blocks, such as State Store and Configuration, in future iterations.
